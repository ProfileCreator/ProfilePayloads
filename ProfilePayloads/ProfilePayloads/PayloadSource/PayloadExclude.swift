...
public class PayloadExclude {
    ...
    init?(payload: Payload, payloadSubkey: PayloadSubkey, exclude: [String: Any]) {

        // ---------------------------------------------------------------------
        //  Store the passed variables
        // ---------------------------------------------------------------------
        self.dictionary = exclude
        ...
        // ---------------------------------------------------------------------
        self.ignoredKeys = exclude

        // ---------------------------------------------------------------------
        //  Verify we got what we expected
        // ---------------------------------------------------------------------
        guard let targetConditions = exclude[ManifestKey.targetConditions.rawValue] as? [[String: Any]] else {
            Swift.print("Class: \(self.self), Function: \(#function), Exclude dict doesn't contain required key: \(ManifestKey.targetConditions.rawValue)")
            return nil
        }
